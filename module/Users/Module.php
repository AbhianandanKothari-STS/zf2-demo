...
class Module implements AutoloaderProviderInterface
{
    public function getAutoloaderConfig()
    {
        return array(
		    ...
		    // if we're in a namespace deeper than one level we need to fix the \ in the path
                	...
                	'TestClass' => 'vendor/ZF2/library/TestClass',
                ),
            ),
        );
    }
    ...
    {
    	//The ModuleRouteListener prepends the module name to the requested controller name.
		//That's useful if you want to use controller short names in routing
